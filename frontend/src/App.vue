...
const overrides: GlobalThemeOverrides = {
  ...
  Button: {
    ...
    borderRadiusSmall: '8',
    fontWeight: '600',
    colorPrimary: 'var(--color-rose)',
    colorHoverPrimary: 'var(--color-rose-hover)',
    colorPressedPrimary: 'var(--color-rose-pressed)',
    colorFocusPrimary: 'var(--color-rose-hover)',
    textColorPrimary: '#ffffff',
    borderColorPrimary: 'var(--color-rose)',
  },
  Input: {
  ...
  Tabs: {
    tabTextColorActiveBar: 'var(--color-rose)',
    tabTextColorActive: 'var(--color-rose)',
    tabTextColorHover: 'var(--color-rose)',
